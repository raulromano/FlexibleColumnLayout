		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#rrmflexiblecolumnlayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rrmflexiblecolumnlayout-display": {
								"semanticObject": "rrmflexiblecolumnlayout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rrm.flexiblecolumnlayout",
									"url": sap.ui.require.toUrl("rrm/flexiblecolumnlayout")
								}
							}
						}
					}
